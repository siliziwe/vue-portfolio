<template>
  <div class="about">
    <h1 class="text-center border border-dark border-3 bg-light">About</h1>
  </div>
...
<div class="container mb-5" id="cont">
  ...
  <div class="column my-5" id="column2">
    <h3 class="text-center bg-light">About Me</h3>
...
<div class="row justify-content-center text-center">
  <div class="col-md-4 mb-4 mb-md-5">
    <div class="card">
    <h3 class="text-center bg-light">Hobbies</h3>
  ...
  <div class="col-md-4 mb-4 mb-md-0">
    ...
    <h3 class="text-center bg-light">Music</h3>
  ...
  <div class="col-md-4 mb-4 mb-md-0">
    <div class="card mask-custom-2">
    <h3 class="text-center bg-light">Favourite Quotes</h3>
      <p>
